...
<?php unset($this->config['actions']) ?>
  ...
  {
    return <?php echo $this->asPhp(isset($this->config['form']['actions']) ? $this->config['form']['actions'] : array('_list' => null, '_save' => null, '_save_and_add' => null,'_delete' => null)) ?>;
...
<?php if(isset($this->params) && isset($this->params['with_show']) && $this->params['with_show'] == true): ?>
    return <?php echo $this->asPhp(isset($this->config['edit']['actions']) ? $this->config['edit']['actions'] : array('_list' => null, '_show' => null, '_save' => null, '_save_and_add' => null, '_delete' => null)) ?>;
<?php else: ?>
